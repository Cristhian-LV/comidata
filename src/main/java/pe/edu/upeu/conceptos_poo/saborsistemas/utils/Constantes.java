...
// RUTAS FXML:
    ...
    String fxml_personal= "/fxml/gestion_personal.fxml";
    String fxml_clientes= "/fxml/gestion_clientes.fxml";
...
// --- ITEM STRUCTS ---
    ...
    MenuItemStruct miGestionInventario = new MenuItemStruct("menuitem.nombre.gestion_inventario", "GESTION_INVENTARIO", null);
